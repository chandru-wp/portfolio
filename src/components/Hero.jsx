...
import vijayImage from "../assets/thalapathi.png";
...
export default function Hero() {
  ...
  const [profile, setProfile] = useState({
    name: "Chandru K",
    about: "Tech isn't just what I do—it's how I think. With AI in my toolkit and full-stack development in my hands, I'm building systems that solve real-world problems."
  });
      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center">
        ...
        <div className="animate-fadeIn space-y-6 text-center md:text-left">
          ...
          <p className="mt-4 md:mt-6 text-gray-700 leading-relaxed text-sm sm:text-base md:text-lg lg:text-xl max-w-md md:max-w-lg mx-auto md:mx-0">
            {profile.about ||
              "Tech isn't just what I do—it's how I think. With AI in my toolkit and full-stack development in my hands, I'm building systems that solve real-world problems. I don't follow the future—I create it."}
          </p>
          ...
          <div className="mt-6 md:mt-8 flex flex-wrap justify-center md:justify-start gap-3 sm:gap-4">
            <button
              ...
              className="px-8 py-3 sm:px-10 sm:py-4 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-full font-bold text-sm sm:text-base shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 active:scale-95"
            >
              Get In Touch
            </button>
            ...
            <button
              ...
              className="px-8 py-3 sm:px-10 sm:py-4 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-full font-bold text-sm sm:text-base shadow-lg hover:shadow-2xl hover:scale-110 transition-all duration-300 active:scale-95 flex items-center gap-2 cursor-pointer"
            >
              📄 Resume <span>⬇</span>
            </button>
          </div>
